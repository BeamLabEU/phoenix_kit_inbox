defmodule PhoenixKitInbox.ActivityLogAssertions do
  @moduledoc """
  Helpers for asserting activity log entries landed with the right
  action, module, and metadata shape.

  Imported into `PhoenixKitInbox.DataCase` and
  `PhoenixKitInbox.LiveCase` so every DB-backed test can reach
  them.
  """
  ...
  ## Example
      ...
      assert_activity_logged("inbox.demo_event",
